        ...
        <header>
            <div class="row">
                <div class="col col-md-6">
                    <p>Nomor Registrasi : {{ $cetakspb->no_regis }}</p>
                </div>
                <div class="col col-md-6">
                    <p>Nomor : </p>
                </div>
        ...
        <section>
            <div class="info_kapal mb-3">
                <div class="row">
                    <div class="col col-md-6">
                        <div class="mb-3">
                            <p>Nama Kapal : {{ $cetakspb->kapal->nama }}
                                <br> <span>Ship Name </span>
                            </p>
                        </div>
                        <div class="mb-3">
                            <p>Bendera Kebangsaan : {{ $cetakspb->bendera }}
                                <br> <span>Nationality Flag </span>
                            </p>
                        </div>
                        <div class="mb-3">
                            <p>Nomor IMO : {{ $cetakspb->no_imo }}
                    ...
                    <div class="col col-md-6">
                        <div class="mb-3">
                            <p>Tonase Kotor : {{ $cetakspb->gt }}
                                <br> <span>Gross Tonage </span>
                            </p>
                        </div>
                        <div class="mb-3">
                            <p>Nakhoda : {{ $cetakspb->nakhoda }}
                                <br> <span>Master </span>
                            </p>
                        </div>
                        <div class="mb-3">
                            <p>Tanda Panggilan : {{ $cetakspb->call_sign }}
        ...
        <section>
            <div class="isi_surat mb-3">
                <p>Sesuai dengan Surat Pernyataan Keberangkatan Kapal yang dibuat oleh Nakhoda kapal tanggal
                    {{ $cetakspb->tgl_nakhoda }} Pukul {{ $cetakspb->jam_nakhoda }} WS, <br>
                    <span>In accordance with Sailing Declaration Issud by Master on dated {{ $cetakspb->tgl_nakhoda }}
                        Time
                        {{ $cetakspb->jam_nakhoda }} LT,</span>
                </p>
            ...
            <div class="info_spb">
                <div class="row">
                    <div class="col col-md-4">
                        <p>Bertolak Dari :{{ $cetakspb->bertolak }} <br>
                            <span>Departure from</span>
                        </p>
                        <p>Jumlah Awak Kapal : {{ $cetakspb->jml_crew }}<br>
                            <span>Number Of Ship Crew</span>
                        </p>
                        <p>Tempat diterbitkan : {{ $cetakspb->tmp_terbit }} <br>
                            <span>Place Of Issued</span>
                        </p>
                        <p>Pada Tanggal : {{ $cetakspb->tgl_terbit }} <br>
                            <span>Date</span>
                        </p>
                        <p>Jam : {{ $cetakspb->jam_terbit }} <br>
                            <span>Time</span>
                        </p>
                    </div>
                    <div class="col col-md-4">
                        <p>Pada tanggal / jam : {{ $cetakspb->tgl_bertolak }} / {{ $cetakspb->jam_bertolak }} <br>
                            <span>on date / time</span>
                        </p>
                    </div>
                    <div class="col col-md-4">
                        <p>Pelabuhan Tujuan : {{ $cetakspb->pelabuhan->nama }}<br>
                            <span>Port of destination</span>
                        </p>
                        <p>Dengan Muatan : {{ $cetakspb->muatan }} <br>
