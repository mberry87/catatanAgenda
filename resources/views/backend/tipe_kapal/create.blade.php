...
@section('title', 'Tambah Tipe Kapal')

@section('breadcrumb')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h4 class="m-0">Tambah Tipe Kapal</h4>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                <li class="breadcrumb-item active">Tambah Tipe Kapal</li>
            </ol>
        </div>
    </div>
@endsection
    ...
    <div class="row">
        <div class="col col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('tipe_kapal.store') }}" class="form-horizontal form-label-left" method="POST">
                        @csrf
